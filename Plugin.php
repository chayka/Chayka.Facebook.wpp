...
class Plugin extends WP\Plugin{
    ...
    public function registerRoutes() {
        ...
        $this->addRoute('site-thumbnail', 'facebook/site-thumbnail/:format/:hash', ['controller' => 'facebook', 'action'=>'site-thumbnail']);
        $this->addRoute('taxonomy-thumbnail', 'facebook/taxonomy-thumbnail/:taxonomy/:term/:format/:hash', ['controller' => 'facebook', 'action'=>'taxonomy-thumbnail']);
        $this->addRoute('post-thumbnail', 'facebook/post-thumbnail/:image_id/:format/:hash', ['controller' => 'facebook', 'action'=>'post-thumbnail']);
    }
